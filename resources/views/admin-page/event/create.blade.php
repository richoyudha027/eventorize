                    ...
                    <div class="card-body">
                        <form action="{{ route('crud-event.store') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                <label class="text-gray-800 font-weight-bold" for="event_name">Event Name</label>
                                <input type="text" class="form-control @error('event_name') is-invalid @enderror" id="event_name" name="event_name"
                            ...
                            <div class="row">
                                <div class="col">
                                    <div class="form-group">
                                        <label class="text-gray-800 font-weight-bold" for="organizer">Organizer</label>
                                        <input type="text" class="form-control @error('organizer') is-invalid @enderror" id="organizer" name="organizer"
                            ...
                            <div class="d-flex justify-content-between">
                                <a href="{{ route('crud-event.index') }}" class="btn btn-primary">Back</a>
