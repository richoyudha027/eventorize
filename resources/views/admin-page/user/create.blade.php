...
<head>
    <title>Add User- Eventorize</title>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <!-- Sidebar Toggle (Topbar) -->
                ...
                <div class="container-fluid">
                    <h1 class="h3 mb-2 font-weight-bold text-gray-800" style="line-height: 1.2;">Add User</h1>
                </div>
                ...
                <div class="d-sm-flex align-items-center justify-content-between mb-4">
                    <div class="card-body">
                        <form action="{{ route('users.store') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                <div class="col">
                                    <div class="form-group">
                                        <label class="text-gray-800 font-weight-bold" for="name">User Name</label>
                            ...
                            <!-- Role (disembunyikan dan default ke user) -->
