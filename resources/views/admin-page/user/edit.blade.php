...
<head>
    <title>Edit User - Eventorize</title>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <!-- Sidebar Toggle (Topbar) -->
                ...
                <div class="container-fluid">
                    <h1 class="h3 mb-2 font-weight-bold text-gray-800 mr-2" style="line-height: 1.2;">Edit User</h1>
                </div>

                <!-- Begin Page Content -->
                <div class="d-sm-flex mb-4">
                    <div class="card-body col-md-4">
                        <label class="font-weight-bold text-gray-800 mr-2" for="photo">User Photo</label>
                        @if($user->photo)
                            <img src="{{ asset('storage/img/'.$user->photo) }}" alt="{{ $user->photo }}" class="card-img" style="max-width: 100%; height: auto;">
                        @else
                            <p>No Photo</p>
                        @endif
                    </div>
                    <div class="card-body">
                        ...
                        <form action="{{ route('users.update', $user->id) }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                ...
                                <div class="col">
                                    <div class="form-group">
                                        <label class="font-weight-bold text-gray-800 mr-2" for="address">Address</label>
                                ...
                                <div class="col">
                                     <div class="form-group">
                                        <label class="font-weight-bold text-gray-800 mr-2" for="gender">Gender</label>
                                ...
                                <div class="col">
                                    <div class="form-group">
                                        <label class="font-weight-bold text-gray-800 mr-2" for="dob">Date of Birth</label>
