<nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
    ...
    <!-- Topbar Search -->
    <form action="{{ route('crud-event.index') }}" method="GET" class="d-none d-sm-inline-block form-inline mr-auto ml-md-3 my-2 my-md-0 mw-100 navbar-search">
        <div class="input-group">
            <input type="text" name="search" class="form-control bg-light border-0 small" placeholder="Search by Event Name, Location, Category, etc.." value="{{ request()->get('search') }}"
    ...
    <ul class="navbar-nav ml-auto">
        ...
        <li class="nav-item dropdown no-arrow">
            ...
            @if (empty(Auth::user()->image))
                <img class="img-profile rounded-circle" src="{{ asset('storage/img/default.png') }}">
            @else
                <img class="img-profile rounded-circle" src="{{ asset('storage/img/' . Auth::user()->image) }}" alt="User Image">
            @endif
            </a>
